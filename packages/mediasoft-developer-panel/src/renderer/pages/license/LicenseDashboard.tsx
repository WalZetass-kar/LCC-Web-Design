...
export default function LicenseDashboardPage() {
  ...
  const cards = [
    ...
    { label: 'Subscription Aktif', value: stats?.active_subscriptions ?? 0, icon: TrendingUp, color: 'text-emerald-600' },
    { label: 'Subscription Expired', value: stats?.expired_subscriptions ?? 0, icon: ShieldAlert, color: 'text-red-600' },
