...
export function UserPanelRoutes() {
  return (
    <>
      ...
      <Route path="subscription-plans" element={<Navigate to="/developer" replace />} />
      <Route path="tutorials" element={<Tutorials />} />
      <Route path="hpp" element={<Hpp />} />
      <Route path="promo" element={<Promo />} />
      <Route path="branch" element={<RequireRoles allowedRoles={['developer', 'super_admin']}><Branch /></RequireRoles>} />
