    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        <div className="flex gap-2 w-full sm:w-auto">
          ...
          <Button icon={<ShoppingCart size={16} />} onClick={() => navigate('/app/transaksi')} className="w-full sm:w-auto">
            Mulai Transaksi
          </Button>
        </div>
      </div>
            ...
            {loading ? (
              ...
              <Card title="Ringkasan Minggu Ini">
                ...
                <div className="mt-4 sm:mt-5 pt-4 border-t border-slate-100 dark:border-slate-700">
                  <Button variant="secondary" className="w-full" onClick={() => navigate('/app/riwayat')}>
                    Lihat Semua Riwayat
                  </Button>
                </div>
              </Card>
